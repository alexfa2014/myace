                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form method="POST" action="/common/auth/login">
                                        <fieldset>
                                            ...
                                            <?php echo isset($usernameErr) ? '账户密码错误！' : '';?>
...
<script src="/static/2.0.3jquery.min.js"></script>

<!-- <![endif]-->

<!--[if IE]>
<script src="/static/1.10.2jquery.min.js"></script>
<![endif]-->
